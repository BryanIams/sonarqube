...
public class AuthorizationDao {
  ...
  List<Dto> selectAfterDate(DbClient dbClient, DbSession session, long afterDate) {
    return doSelectAfterDate(dbClient, session, afterDate, Collections.emptyList());
  }

  List<Dto> selectAfterDate(DbClient dbClient, DbSession session, long afterDate, List<String> projectUuids) {
    return executeLargeInputs(projectUuids, subProjectUuids -> doSelectAfterDate(dbClient, session, afterDate, subProjectUuids));
  }

  private List<Dto> doSelectAfterDate(DbClient dbClient, DbSession session, long afterDate, List<String> projectUuids) {
    try {
      Map<String, Dto> dtosByProjectUuid = Maps.newHashMap();
      PreparedStatement stmt = null;
      ResultSet rs = null;
      try {
        stmt = createStatement(dbClient, session, afterDate, projectUuids);
  ...
  private static PreparedStatement createStatement(DbClient dbClient, DbSession session, long afterDate, List<String> projectUuids) throws SQLException {
    String sql;
