...
public interface GroupPermissionMapper {
  ...
  List<Long> selectGroupIdsByQuery(@Param("organizationUuid") String organizationUuid, @Param("query") PermissionQuery query, RowBounds rowBounds);

  int countGroupsByPermissionQuery(@Param("organizationUuid") String organizationUuid, @Param("query") PermissionQuery query);
